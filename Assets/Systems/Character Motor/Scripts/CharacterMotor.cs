...
{ 
    ...
    public class CharacterMotor : MonoBehaviour
    {
        ...
        {
            Vector3 lookAheadStartPoint = transform.position + Vector3.up * (Config.StepCheck_MaxStepHeight * 0.5f);
            ...
            if (Physics.Raycast(lookAheadStartPoint, lookAheadDirection, lookAheadDistance, Config.GroundedLayerMask, QueryTriggerInteraction.Ignore))
            {   
                lookAheadStartPoint = transform.position + Vector3.up * Config.StepCheck_MaxStepHeight;
...

                {
                    ...
                    // check the surface of the stop
                    RaycastHit hitResult;
                    if (Physics.Raycast(candidatepoint, Vector3.down, out hitResult, Config.StepCheck_MaxStepHeight + 2f, Config.GroundedLayerMask, QueryTriggerInteraction.Ignore))
                    {
        ...
        public void SoftMovementLock(bool locked)
        {
